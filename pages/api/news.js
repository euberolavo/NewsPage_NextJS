export default async function handler(req, res) {
    try {
      const response = await fetch('https://newsapi.org/v2/everything?q=apple&from=2023-06-14&to=2023-06-11&sortBy=popularity&apiKey=c3ac317f3b854003aa5a80fec4b5ba34');
